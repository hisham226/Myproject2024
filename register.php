                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example3c"><i class="bi bi-envelope-at-fill"></i> Your PhoneNumber</label>
                        <input type="number" id="form3Example3c" class="form-control form-control-lg py-3" name="username" autocomplete="off" placeholder="enter your phone number" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example5c"><i class="bi bi-image"></i> Profile Image</label>
                        <input type="file" id="form3Example5c" class="form-control form-control-lg py-3" name="profile_image" style="border-radius:25px ;" />
                      </div>
                    </div>
