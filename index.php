  ...
  <section class="vh-100">
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-md-8 col-lg-7 col-xl-6">
          <img src="login.jpg" class="img-fluid" alt="Phone image" height="300px" width="600px">
        </div>
   ...
   <!-- Email input -->
            <div class="form-outline mb-4">
              <label class="form-label" for="form1Example13"> <i class="bi bi-person-circle"></i> PhoneNumber</label>
              <input type="number " id="form1Example13" class="form-control form-control-lg py-3" name="username" autocomplete="off" placeholder="enter your PhoneNumber " style="border-radius:25px ;" />
